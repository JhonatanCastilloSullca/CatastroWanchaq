...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ubicacion_certificado_catastrals', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('via_id')->references('id_via')->on('tf_vias');
    ...
    {
        Schema::dropIfExists('ubicacion_certificado_catastrals');
    }
};
