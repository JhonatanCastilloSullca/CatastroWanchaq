...
public function fichaCotitularidad(Ficha $ficha)
    ...
    public function anexoficha($sector)
    {
        ...
        $html = view('pages.pdf.anexoficha', compact(
            'titulares',
            'sectores',
            'sector2',
            'numero',
    ...
    public function anexofichaExcel($sector)
    {
        ...
        return Excel::download(
            new LotesPropietariosExports($titulares, $sectores, $sector2, $numero, $logos, $fecha, $hora),
            'anexoficha.xlsx'
        );
    }
