                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="area_titulo" wire:model="area_titulo" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="10" tabindex="72">
                                    @error('area_titulo')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div>
                                    ...
                                    <input type="file" accept="image/jpeg, image/png" class="form-control" name="imagen_lote" id="imagen_lote" wire:model="nuevaImagen">
                                </div>
                                <div>
                                    <img src="{{ asset('storage/img/imageneslotes/' . $imagen_lote) }}" alt="Imagen de lote" width="200" height="150">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div>
                                    ...
                                    <input type="file" accept="image/jpeg, image/png" class="form-control" name="imagen_plano" id="imagen_plano" wire:model="nuevaImagenPlano">
                                </div>
                                <div>
                                    <img src="{{ asset('storage/img/imagenesplanos/' . $imagen_plano) }}" alt="Imagen de lote" width="200" height="150">
                                </div>
                            </div>
                        </div><!-- Row -->
