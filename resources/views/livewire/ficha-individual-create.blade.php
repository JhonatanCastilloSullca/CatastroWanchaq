                    ...
                    <h3 class="mb-4">Ficha Catastral Urbana Individual</h3>
                        ...
                        <div class="row  form-group">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <div class="row row3 mb-3 align-items-center" style="place-content: center;text-align: center;">
                                        ...
                                        <div class="col-md-3 row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="mzna" wire:model.defer="mzna" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="3" tabindex="9">
                                                @error('mzna')
                                                <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-1">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="lote" wire:model.defer="lote" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="3" tabindex="10">
                                                @error('lote')
                                                <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-1">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="edifica" wire:model.defer="edifica" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="2" tabindex="11">
                                                @error('edifica')
                                                <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-1">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="entrada" wire:model.defer="entrada" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="2" tabindex="12">
                                                @error('entrada')
                                                <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-1">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="piso" wire:model.defer="piso" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="2" tabindex="13">
                                                @error('piso')
                                                <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-1">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="unidad" wire:model.defer="unidad" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="3" tabindex="14">
                                                @error('unidad')
                                                <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <button type="button" class="btn btn-primary btn-icon mt-3" wire:click="calcularDC">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label d-inline-flex">
                                        <div class="divcuadro">11</div> TIPO DE INTERIOR
                                    </label>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="nume_interior" wire:model="nume_interior" maxlength="4" t  abindex="25">
                                    @error('nume_interior')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="row form-group" id="ubicacion">
                            <div class="col-md-2">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="codigoviaotros" maxlength="6" wire:model.lazy="codigoviaotros" tabindex="51">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="area_titulo" wire:model="area_titulo" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="8" tabindex="72">
                                    @error('area_titulo')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div>
                                    ...
                                    <table id="vias" class="table">
                                        ...
                                        <tbody>
                                            @for($i=0;$i<$cont3;$i++) <tr>
                                                ...
                                                <td>
                                                    <input type="date" class="form-control" name="inst_fecha[]" placeholder="FECHA" id="inst-fecha.{{$i}}" wire:model="inst_fecha.{{$i}}" tabindex="109">
                                                    @error('inst_fecha.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                    ...
                                    <table id="vias" class="table">
                                        ...
                                        <tbody>
                                            @for($i=0;$i<$cont4;$i++) <tr>
                                                ...
                                                <td>
                                                    <input type="file" accept="application/pdf" class="form-control" name="url_doc.{{$i}}" id="url_doc.{{$i}}" wire:model.defer="url_doc.{{$i}}">
                                                </td>
                                                <td>
                                                    @if($i==$cont4-1)
                                    ...
                                    <table id="vias" class="table">
                                        ...
                                        <tbody>
                                            @for($i=0;$i<$cont5;$i++) <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="nume_doclitigante[]" placeholder="NUMERO DE DOCUMENTO" id="nume_doc{{$i}}" wire:model.lazy="numedoc.{{$i}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="17" tabindex="142">
                                                ...
                                                <td>
                                                    @if($i==$cont5-1)
                                                    <button type="button" class="btn btn-success btn-icon" wire:click="aumentarinformacion" tabindex="142">+</button>
                                                    @endif
                                                </td>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" tabindex="162" wire:click.prevent="register">Guardar</button>
                            <button type="button" class="btn btn-primary" tabindex="162" wire:click.prevent="focusInput">Guardar</button>
...
<script>
    ...
    function agregarValores() {
        ...
        if ($("#ubicacionpersona option:selected").val() == "01") {
            ...
            $('#distritootros').empty();
            $('#distritootros').append("<option value='01' ></option>");
        } else {
            $('#departamentootros').empty();
