                    ...
                    <div class="row">
                        ...
                        <div class="row form-group">
                            {{-- <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="nomb_edificacion" wire:model="nomb_edificacion" onkeydown="return /[a-z]/i.test(event.key)" maxlength="100" tabindex="19">
                            ...
                            <div class="lineatoggle">
                                ...
                                <div style="padding-left: 10px;">
                                    <div class="form-check form-switch mb-2">
                                        <input type="checkbox" class="form-check-input" id="formSwitch1" name="luz" wire:model="luz" tabindex="50">
                                    </div>
                                </div>
                            </div>
                            <div class="lineatoggle">
                                ...
                                <div style="padding-left: 10px;">
                                    <div class="form-check form-switch mb-2">
                                        <input type="checkbox" class="form-check-input" id="luz" name="agua" wire:model="agua" tabindex="51">
                                    </div>
                                </div>
                            </div>
                            <div class="lineatoggle">
                                ...
                                <div style="padding-left: 10px;">
                                    <div class="form-check form-switch mb-2">
                                        <input type="checkbox" class="form-check-input" id="luz" name="telefono" wire:model="telefono" tabindex="52">
                                    </div>
                                </div>
                            </div>
                            <div class="lineatoggle">
                                ...
                                <div style="padding-left: 10px;">
                                    <div class="form-check form-switch mb-2">
                                        <input type="checkbox" class="form-check-input" id="luz" name="desague" wire:model="desague" tabindex="53">
                                    </div>
                                </div>
                            </div>
                            <div class="lineatoggle">
                                ...
                                <div style="padding-left: 10px;">
                                    <div class="form-check form-switch mb-2">
                                        <input type="checkbox" class="form-check-input" id="luz" name="gas" wire:model="gas" tabindex="54">
                                    </div>
                                </div>
                            </div>
                            <div class="lineatoggle">
                                ...
                                <div style="padding-left: 10px;">
                                    <div class="form-check form-switch mb-2">
                                        <input type="checkbox" class="form-check-input" id="luz" name="internet" wire:model="internet" tabindex="55">
                                    </div>
                                </div>
                            </div>
                            <div class="lineatoggle">
                                ...
                                <div style="padding-left: 10px;">
                                    <div class="form-check form-switch mb-2">
                                        <input type="checkbox" class="form-check-input" id="luz" name="tvcable" wire:model="tvcable" tabindex="56">
                                    </div>
                                </div>
                            </div>
                        </div><!-- Row -->
                                    ...
                                    <table id="vias" class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-icon" wire:click="reducirConstruccion" tabindex="57">-</button>
                                                    @else
                                                    <button type="button" class="btn btn-success btn-icon" wire:click="aumentarConstruccion" tabindex="57">+</button>
                                                    @endif
                                                    @endif
                                        ...
                                        <tbody>
                                            @for($i=0;$i<$cont2;$i++) <tr>
                                                <td>
                                                    <input type="text" class="form-control" name="bloque[]" placeholder="Bloque" id="bloque.{{$i}}" wire:model="bloque.{{$i}}" maxlength="2" tabindex="57">
                                                    @error('bloque.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="nume_piso[]" placeholder="N° piso" id="num_piso.{{$i}}" wire:model="num_piso.{{$i}}" maxlength="2" tabindex="57">
                                                    @error('num_piso.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="month" class="form-control" name="fecha[]" placeholder="FECHA" id="fecha.{{$i}}" wire:model="fecha.{{$i}}" tabindex="57">
                                                    @error('fecha.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <select class="form-select" data-width="100%" data-live-search="true" name="mep.{{$i}}" id="mep.{{$i}}" wire:model="mep.{{$i}}" tabindex="57">
                                                        <option value="">SELECCIONE</option>
                                                ...
                                                <td>
                                                    <select class="form-select" data-width="100%" data-live-search="true" name="ecs.{{$i}}" id="ecs.{{$i}}" wire:model="ecs.{{$i}}" tabindex="57">
                                                        <option value="">SELECCIONE</option>
                                                ...
                                                <td>
                                                    <select class="form-select" data-width="100%" data-live-search="true" name="ecc.{{$i}}" id="ecc.{{$i}}" wire:model="ecc.{{$i}}" tabindex="57">
                                                        <option value="">SELECCIONE</option>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="estr_muro_col[]" placeholder="MUROS" wire:model="estr_muro_col.{{$i}}" onkeydown="return /[a-z. ;]/i.test(event.key)" maxlength="1" tabindex="57">
                                                    @error('estr_muro_col.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="estr_techo[]" placeholder="TECHOS" wire:model="estr_techo.{{$i}}" onkeydown="return /[a-z. ;]/i.test(event.key)" maxlength="1" tabindex="57">
                                                    @error('estr_techo.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="acab_piso[]" placeholder="PISOS" wire:model="acab_piso.{{$i}}" onkeydown="return /[a-z. ;]/i.test(event.key)" maxlength="1" tabindex="57">
                                                    @error('acab_piso.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="acab_puerta_ven[]" placeholder="P. Y V." wire:model="acab_puerta_ven.{{$i}}" onkeydown="return /[a-z. ;]/i.test(event.key)" maxlength="1" tabindex="57">
                                                    @error('acab_puerta_ven.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="acab_revest[]" placeholder="REVEST." wire:model="acab_revest.{{$i}}" onkeydown="return /[a-z. ;]/i.test(event.key)" maxlength="1" tabindex="57">
                                                    @error('acab_revest.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="acab_bano[]" placeholder="BAÑOS" wire:model="acab_bano.{{$i}}" onkeydown="return /[a-z. ;]/i.test(event.key)" maxlength="1" tabindex="57">
                                                    @error('acab_bano.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="inst_elect_sanita[]" placeholder="INST. E." wire:model="inst_elect_sanita.{{$i}}" onkeydown="return /[a-z. ;]/i.test(event.key)" maxlength="1" tabindex="57">
                                                    @error('inst_elect_sanita.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="area_verificada[]" placeholder="AREA VERIFICADA" wire:model="area_verificada.{{$i}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="9" tabindex="57">
                                                    @error('area_verificada.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <select class="form-select" data-width="100%" data-live-search="true" name="uca.{{$i}}" id="uca.{{$i}}" wire:model="uca.{{$i}}" tabindex="57">
                                                        <option value="">SELECCIONE</option>
                                    ...
                                    <table id="vias" class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    @if($cont3>0)
                                                    <button type="button" class="btn btn-danger btn-icon" wire:click="reducirObras" tabindex="58">-</button>
                                                    @else
                                                    <button type="button" class="btn btn-success btn-icon" wire:click="aumentarObras" tabindex="58">+</button>
                                                    @endif
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @for($i=0;$i<$cont3;$i++) <tr>
                                                <td>
                                                    <select class="form-select" data-width="100%" data-live-search="true" name="codiinstalacion.{{$i}}" id="codiinstalacion.{{$i}}" wire:model.defer="codiinstalacion.{{$i}}" tabindex="58">
                                                        <option value="">SELECCIONE</option>
                                                ...
                                                <td>
                                                    <input type="month" class="form-control" name="inst_fecha[]" placeholder="FECHA" id="inst-fecha.{{$i}}" wire:model.defer="inst_fecha.{{$i}}" tabindex="58">
                                                    @error('inst_fecha.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <select class="form-select" data-width="100%" data-live-search="true" name="inst_mep.{{$i}}" id="inst_mep.{{$i}}" wire:model.defer="inst_mep.{{$i}}" tabindex="58">
                                                        <option value="">SELECCIONE</option>
                                                        @foreach(\App\Models\TablaCodigo::where('id_tabla','=','MEP')->orderby('codigo','asc')->get() as $tablacodigo)
                                                        <option value="{{$tablacodigo->codigo}}">{{$tablacodigo->codigo}} {{$tablacodigo->desc_codigo}}</option>
                                                        @endforeach
                                                ...
                                                <td>
                                                    <select class="form-select" data-width="100%" data-live-search="true" name="inst_ecs.{{$i}}" id="inst_ecs.{{$i}}" wire:model.defer="inst_ecs.{{$i}}" tabindex="58">
                                                        <option value="">SELECCIONE</option>
                                                        @foreach(\App\Models\TablaCodigo::where('id_tabla','=','ECS')->orderby('codigo','asc')->get() as $tablacodigo)
                                                        <option value="{{$tablacodigo->codigo}}">{{$tablacodigo->codigo}} {{$tablacodigo->desc_codigo}}</option>
                                                        @endforeach
                                                ...
                                                <td>
                                                    <select class="form-select" data-width="100%" data-live-search="true" name="inst_ecc.{{$i}}" id="inst_ecc.{{$i}}" wire:model.defer="inst_ecc.{{$i}}" tabindex="58">
                                                        <option value="">SELECCIONE</option>
                                                        @foreach(\App\Models\TablaCodigo::where('id_tabla','=','ECC')->orderby('codigo','asc')->get() as $tablacodigo)
                                                        <option value="{{$tablacodigo->codigo}}">{{$tablacodigo->codigo}} {{$tablacodigo->desc_codigo}}</option>
                                                        @endforeach
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="dime_ancho[]" placeholder="D. ancho" id="dime_ancho.{{$i}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="7" wire:model.defer="dime_ancho.{{$i}}" tabindex="58">
                                                    @error('dime_ancho.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="dime_alto[]" placeholder="D. alto" id="dime_alto.{{$i}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="7" wire:model.defer="dime_alto.{{$i}}" tabindex="58">
                                                    @error('dime_alto.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td> --}}
                                                ...
                                                <td>
                                                    <input type="text" class="form-control" name="inst_uni_med[]" placeholder="U. MEDIDA" id="inst-uni_med.{{$i}}" maxlength="2" wire:model.defer="inst_uni_med.{{$i}}" tabindex="58">
                                                    @error('inst_uni_med.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <select class="form-select" data-width="100%" data-live-search="true" name="inst_uca.{{$i}}" id="inst_uca.{{$i}}" wire:model.defer="inst_uca.{{$i}}" tabindex="58">
                                                        <option value="">SELECCIONE</option>
                                                        @foreach(\App\Models\TablaCodigo::where('id_tabla','=','UCA')->orderby('codigo','asc')->get() as $tablacodigo)
                                                        <option value="{{$tablacodigo->codigo}}">{{$tablacodigo->codigo}} {{$tablacodigo->desc_codigo}}</option>
                                                        @endforeach
                                    ...
                                    <table id="vias" class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-icon" wire:click="reducirEdificios" tabindex="59">-</button>
                                                    @else
                                                    <button type="button" class="btn btn-success btn-icon" wire:click="aumentarEdificios" tabindex="59">+</button>
                                                    @endif
                                                    @endif
                                                </th>
                                            </tr>
                                        ...
                                        <tbody>
                                            @for($i=0;$i<$cont4;$i++) <tr>
                                                <td>
                                                    <input type="text" class="form-control" name="edificiobbc[]" placeholder="EDIFICACION" id="edificiobbc.{{$i}}" wire:model.defer="edificiobbc.{{$i}}" maxlength="2" tabindex="60">
                                                    @error('edificiobbc.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="porcentaje[]" placeholder="%" id="porcentaje.{{$i}}" wire:model.defer="porcentaje.{{$i}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\.*/g, '$1');" maxlength="7" tabindex="60">
                                                    @error('porcentaje.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="atc[]" placeholder="ATC" id="atc.{{$i}}" wire:model.defer="atc.{{$i}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="10" tabindex="60">
                                                    @error('atc.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="acc[]" placeholder="ACC" id="acc.{{$i}}" wire:model.defer="acc.{{$i}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="10" tabindex="60">
                                                    @error('acc.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="aoic[]" placeholder="AOIC" id="aoic.{{$i}}" wire:model.defer="aoic.{{$i}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="10" tabindex="60">
                                                    @error('aoic.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    ...
                                                    @if($i==$cont4-1)
                                                    <button type="button" class="btn btn-success btn-icon" wire:click="aumentarEdificios" tabindex="60">+</button>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="en_colindante" class="form-control" placeholder="EN LOTE COLINDANTE" name="en_colindante" wire:model="en_colindante" maxlength="8" tabindex="61">
                                    @error('en_colindante')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="en_jardin_aislamiento" class="form-control" placeholder="EN JARDIN  DE AISLAMIENTO" name="en_jardin_aislamiento" wire:model="en_jardin_aislamiento" oninput="this.value = this.value.replace(/[^0-9,.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="8" tabindex="62">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="en_area_publica" class="form-control" placeholder="EN AREA PUBLICA" name="en_area_publica" wire:model="en_area_publica" maxlength="8" tabindex="63">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="en_area_intangible" class="form-control" placeholder="EN AREA INTANGIBLE" name="en_area_intangible" wire:model="en_area_intangible" oninput="this.value = this.value.replace(/[^0-9,.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="8" tabindex="64">
                            ...
                            <div class="col-md-12 mb-5">
                                <div class="table-responsive">
                                    <table id="vias" class="table">
                                        ...
                                        <tbody>
                                            @for($i=0;$i<$cont5;$i++) <tr>
                                                <td>

                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="rbcedifica[]" wire:model.defer="rbcedifica.{{$i}}" id="rbcedifica.{{$i}}" maxlength="2">
                                                    @error('rbcedifica.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="rbcentrada[]" wire:model.defer="rbcentrada.{{$i}}" id="rbcentrada.{{$i}}" maxlength="2">
                                                    @error('rbcentrada.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="rbcnume_piso[]" wire:model.defer="rbcnume_piso.{{$i}}" id="rbcnume_piso.{{$i}}" maxlength="2">
                                                    @error('rbcnume_piso.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="rbcunidad[]" wire:model.defer="rbcunidad.{{$i}}" id="rbcunidad.{{$i}}" maxlength="3">
                                                    @error('rbcunidad.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="rbctotalporcentaje[]" wire:model.defer="rbctotalporcentaje.{{$i}}" id="rbctotalporcentaje.{{$i}}" oninput="this.value = this.value.replace(/[^0-9,.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="7">
                                                    @error('rbctotalporcentaje.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="rbctotalatc[]" wire:model.defer="rbctotalatc.{{$i}}" id="rbctotalatc.{{$i}}" oninput="this.value = this.value.replace(/[^0-9,.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="9">
                                                    @error('rbctotalatc.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="rbctotalacc[]" wire:model.defer="rbctotalacc.{{$i}}" id="rbctotalacc.{{$i}}" oninput="this.value = this.value.replace(/[^0-9,.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="9">
                                                    @error('rbctotalacc.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control" name="rbctotalaoic[]" wire:model.defer="rbctotalaoic.{{$i}}" id="rbctotalaoic.{{$i}}" oninput="this.value = this.value.replace(/[^0-9,.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="9">
                        ...
                        {{-- <div class="row form-group">
                            ...
                            <div class="col-md-4 mb-3">
                                <div wire:ignore>
                                    <label class="form-label d-inline-flex">
                                        <div class="divcuadro">101</div>NOMBRE DE LA NOTARIA
                                    </label>
                                    <select class="form-select" data-width="100%" data-live-search="true" name="rbcnotaria" wire:model="rbcnotaria" tabindex="134">
                                        <option value="">SELECCIONE</option>
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label d-inline-flex">
                                    <div class="divcuadro">102</div> KARDEX
                                </label>
                                <input type="text" class="form-control" name="rbckardex" wire:model="rbckardex" tabindex="134">
                                @error('rbckardex')
                                <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label d-inline-flex">
                                    <div class="divcuadro">103</div>FECHA DE ESCRITURA
                                </label>

                                <input type="date" class="form-control" name="rbcfechaesc" placeholder="FECHA" id="rbcfechaesc" wire:model="rbcfechaesc" tabindex="134">
                                @error('rbcfechaesc')
                                <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <textarea type="textarea" class="form-control" rows="5" name="observacion" wire:model="observacion" tabindex="141"></textarea>
                                </div>
                                @error('observacion')
                                <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row form-group">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control" name="numdocumentodeclarante" wire:model.lazy="numdocumentodeclarante" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="17" placeholder="DNI declarante" tabindex="142">
                                ...
                                <input type="text" class="form-control" name="nombres_declarante" wire:model="nombres_declarante" onkeydown="return /[a-ñ]/i.test(event.key)" placeholder="Nombre declarante" tabindex="143">
                                ...
                                <input type="text" class="form-control" name="apellido_paterno_declarante" wire:model="apellido_paterno_declarante" onkeydown="return /[a-ñ]/i.test(event.key)" placeholder="A. Paterno declarante" tabindex="144">
                                ...
                                <input type="text" class="form-control" name="apellido_materno_declarante" wire:model="apellido_materno_declarante" onkeydown="return /[a-ñ]/i.test(event.key)" placeholder="A. Materno declarante" tabindex="145">
                                ...
                                <input type="date" class="form-control" name="fecha_declarante" wire:model="fecha_declarante" tabindex="146">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                @enderror
                                <label class="form-label d-inline-flex"> FECHA</label>
                                <input type="date" class="form-control" name="fecha_supervision" wire:model="fecha_supervision" tabindex="148">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                @enderror
                                <label class="form-label d-inline-flex"> FECHA</label>
                                <input type="date" class="form-control" name="fecha_levantamiento" wire:model="fecha_levantamiento" tabindex="150">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="nume_registro" wire:model="nume_registro" tabindex="152">
                                @error('nume_registro')
                                <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                                <label class="form-label d-inline-flex"> FECHA</label>
                                <input type="date" class="form-control" name="fecha_verificacion" wire:model="fecha_verificacion" tabindex="153">
