...
<div class="row inbox-wrapper">
    <div class="col-md-12">
        ...
        <div class="card-body">
            ...
            {!!Form::open(array('url'=>'impresion/vercnumeracion','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                    ...
                    <tbody>
                        @foreach($ficha as $ficha)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('pdf.numeracion',$ficha)}}" target="_blank">
                                ...
                                <td>
                                    <a href="{{route('pdf.generarNumeracion',$ficha)}}" target="_blank">
                                        <button type="button" class="btn btn-success btn-icon " >
                                        <i data-feather="printer"></i>
                                        </button>
                                    </a>
                                    <a href="{{ asset('storage/pdf/numeracion/'.$ficha->id_ficha.'numeracion'.'.pdf') }}" target="_blank">
                                ...
                                <td>
                                    <a href="{{route('pdf.informeeconomico',$ficha)}}" target="_blank">
                                        <button type="button" class="btn btn-dark btn-icon " >
                                        <i data-feather="printer"></i>
                                        </button>
                                    </a>
