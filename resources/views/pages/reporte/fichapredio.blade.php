...
<div class="row inbox-wrapper">
    <div class="col-md-12">
        ...
        <div class="card-body">
            ...
            {!!Form::open(array('url'=>'reporte/fichapredio','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
            <div class="form-group row">
                ...
                <div class="col-md-2">
                    <select class="form-control" id="buscarClasificacion" name="buscarClasificacion"  data-live-search="true">
                        <option value="0" {{ $clasificacion2 == '0' ? 'selected' : '' }} >TODOS</option>
                        @foreach($clasificacion as $clasificacions)
                                <option value="{{$clasificacions->codigo}}" {{ $clasificacion2 == $clasificacions->codigo ? 'selected' : '' }} >{{$clasificacions->codigo}} {{$clasificacions->desc_codigo}}</option>
                        @endforeach
                    </select>
                    <br>                              
                </div>
