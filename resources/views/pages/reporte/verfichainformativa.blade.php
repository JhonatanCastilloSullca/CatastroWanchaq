...
<div class="row inbox-wrapper">
    <div class="col-md-12">
        ...
        <div class="card-body">
            ...
            {!!Form::open(array('url'=>'impresion/verfichainformativa','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                    ...
                    <tbody>
                        @foreach($ficha as $ficha)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('pdf.generarHojaInformativa',$ficha)}}" target="_blank">
                                        <button type="button" class="btn btn-success btn-icon " >
                                        <i data-feather="printer"></i>
                                        </button>
                                    </a>
                                    <a href="{{ asset('storage/pdf/hojainformativa/'.$ficha->id_ficha.'hojainformativa'.'.pdf') }}" target="_blank">
                                        <button type="button" class="btn btn-warning btn-icon">
