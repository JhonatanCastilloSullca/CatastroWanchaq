...
<div class="row inbox-wrapper">
    <div class="col-md-12">
        ...
        <div class="card-body">
            ...
            {!!Form::open(array('url'=>'reporte/fichaconstrucciones','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
            <div class="form-group row">
                ...
                <div class="col-md-1" style="padding-top: 10px">
                        <span> <strong> Tipo de Predio: </strong></span>
                    <br>                              
                </div>
                <div class="col-md-2">
                    <select class="form-control" id="buscarConstruccion" name="buscarConstruccion"  data-live-search="true">
                        <option value="0" {{ $construccion2 == '0' ? 'selected' : '' }} >TODOS</option>
                        @foreach($construccion as $construccions)
                                <option value="{{$construccions->codigo}}" {{ $construccion2 == $construccions->codigo ? 'selected' : '' }} >{{$construccions->codigo}} {{$construccions->desc_codigo}}</option>
                        @endforeach
                    </select>
                    <br>                              
                </div>
