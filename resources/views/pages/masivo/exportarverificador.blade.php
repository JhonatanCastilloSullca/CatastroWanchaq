    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="mb-4">Asignación masiva de Firma Verificador por sector</h4>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="card border">
                            <div class="card-body">
                                ...
                                <h5 class="mb-3">
                                    Exportar archivo Firma Verificador
                                </h5>

                                <form action="{{ route('reporte.guardarverificador') }}"
                                      method="POST">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="card border">
                            <div class="card-body">
                                ...
                                <h5 class="mb-3">
                                    Importar archivo Firma Verificador
                                </h5>

                                <form action="{{ route('reporte.importarverificador') }}"
                                      method="POST"
